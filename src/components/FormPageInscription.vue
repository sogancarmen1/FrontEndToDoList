            ...
            <div :class="{ 'dark': isDark }" class="dark:shadow-black flex">
                ...
                <div :class="{ 'dark': isDark }" class="px-8 dark:bg-black/80">
                    ...
                    <div>
                        ...
                        <input :class="{ 'dark': isDark }" v-model="emailValue" placeholder="Enter your email" type="email" class="dark:bg-black/40 dark:text-white mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"/>
                    ...
                    <div>
                        ...
                        <input v-model="password" placeholder="Enter your password" type="password" class="dark:bg-black/40 dark:text-white mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"/>
                    </div>
                    <div>
                        ...
                        <input v-model="confirmPassword" placeholder="Confirm password" type="password" class="dark:bg-black/40 dark:text-white mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"/>
