...
export default {
  ...
  methods: {
    async onSubmit() {
      ...
      if (
        this.emailRegex.test(this.emailValue) == false &&
        this.emailValue != ""
      ) {
...
<template>
  ...
  <div
    :class="{ dark: isDark }"
    class="md:flex dark:bg-black/50 items-center justify-center h-screen lg:bg-blue-200"
  >
    <div
    ...
    >
      ...
      >
        ...
        >
          <div class="md:flex md:flex-col md:gap-2 mt-[30px] mx-36">
            ...
            <div class="flex space-x-2">
              ...
              <a
                :class="{ dark: isDark }"
                href="#"
                class="dark:bg-black/30 dark:hover:bg-black/60 bg-gray-50 cursor-pointer hover:bg-gray-200 flex gap-2 text-gray-800 font-light text-sm py-4 px-2 border border-gray-200 rounded-full"
              >
                <svg
                  class=""
                  width="19"
            ...
            <div class="py-2">
              <form class="w-full max-w-sm">
                <span
                  class="text-other dark:text-white text-xs"
                  :class="{ dark: isDark }"
                  >Email</span
                >
                ...
                <span
                  :class="{ dark: isDark }"
                  class="text-other text-xs dark:text-white"
                  >Password</span
                >
                <div class="flex items-center border-b border-bordercolor py-2">
                  <input
                ...
                <div class="py-4 flex gap-[20px]">
                    ...
                    <label class="py-4 flex block text-gray-500 font-light">
                      <div>
                        ...
                        >
                          ...
                          />
                          <path
                            :class="showTrueCheckBox ? 'hidden' : 'block'"
                            d="M3 8 L8 14 L17 4"
                            stroke="#7B76F1"
                            stroke-width="1.5"
                          />
                  ...
                  <div>
                    <button
                      @click="onSubmit"
                      type="button"
                      class="bg-logInColor flex flex-nowrap shadow-2xl hover:bg-violet-600 text-white font-bold text-xs py-4 rounded-full"
                      :disabled="showTrueCheckBox"
                      :class="[
                        showTrueCheckBox ? 'cursor-not-allowed' : '',
                        showLoader ? 'px-5' : 'px-10',
                      ]"
                    >
                      <span>SIGN UP</span>
                      <div v-if="showLoader" class="sk-fading-circle">
              ...
              <div
                :class="{ dark: isDark }"
                class="px-20 py-4 text-xs text-password dark:text-white"
              >
                <span>Own an Account?</span>
                <router-link to="/" class="underline font-bold"
  ...
  >
    <div
      :class="{ dark: isDark }"
      class="dark:border-none space-y-2 border rounded-lg bg-white shadow-2xl"
    >
      <div :class="{ dark: isDark }" class="dark:shadow-black flex">
        <div class="">
          <img
            class="w-96 rounded-bl-lg rounded-tl-lg"
        ...
        <div :class="{ dark: isDark }" class="px-8 dark:bg-black/80">
          ...
          <div>
            ...
            <input
              ...
              class="dark:bg-black/40 dark:text-white mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"
            />
            <div v-if="isEqual" class="text-center text-red-600 text-sm">
              password don't match
            </div>
            <div v-if="isEmpty" class="text-center text-red-600">
          ...
          <div class="flex items-center justify-center">
            <span :class="{ dark: isDark }" class="dark:text-white text-sm mr-2"
          ...
          <div class="py-5">
            <button
              :class="{ dark: isDark }"
              @click="onSubmit()"
              class="dark:shadow-black shadow-2xl mx-20 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
              type="button"
            >
              Sign up
            </button>
