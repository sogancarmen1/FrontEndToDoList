...
<template>
    <div v-if="revele" class="flex items-center justify-center h-screen fixed top-0 bottom-0 right-0 left-0">
        <div @click="toggleModale" class="bg-[rgba(0,0,0,0.5)] fixed top-0 bottom-0 right-0 left-0"></div>
                ...
                <div class="px-8 pt-4 flex items-center flex-none">
                    <div>
                        ...
                        <div>
                            ...
                            <select v-model="priority" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1">
                        ...
                        <div>
                            ...
                            <select v-model="status" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1">
