        ...
        <div class="flex">
            <div class="shadow-2xl border-black/30 h-screen w-1/6">
                <div class="my-8 flex flex-col space-y-2">
                    <button @click="toogleProjectToSettings" class="flex mx-8 px-4 py-2 space-x-4 hover:rounded-xl hover:bg-gray-300/50">
                        <svg class="w-8"
                    ...
                    <button @click="toogleSettingsToProject" class="flex mx-8 px-4 py-2 space-x-2 hover:rounded-xl hover:bg-gray-300/50">
                        <svg class="w-8 "
            ...
            <div v-if="isProjectSelected" class="justify-center w-5/6 py-4">
                ...
                <div class="px-8">
                    <div class="flex justify-between">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <div>
                                <button @click="toggleReveleCreateProjectForm" class="my-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                                    Create project
                                </button>
                            </div>
                        </div>
