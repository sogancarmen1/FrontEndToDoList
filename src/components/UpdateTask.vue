...
<template>
  ...
  >
    ...
    <div
      :class="{ dark: isDark }"
      class="dark:bg-black/90 dark:border-none space-y-2 border rounded-lg bg-white shadow-2xl fixed"
    >
      ...
      <div class="px-8 pt-4 flex items-center flex-none">
        <div>
          <div>
            <h1
              :class="{ dark: isDark }"
              class="dark:text-white text-center font-bold py-4 text-2xl text-gray-800"
            >
              Edit a task
            </h1>
            <p
          ...
          <div>
            <p
              :class="{ dark: isDark }"
              class="after:ml-0.5 mt-2 after:text-red-500 block text-sm font-medium text-slate-700 dark:text-white"
            >
              Description
            </p>
            <textarea
